...
var _second = require('./second.component');
...
var AppModule = exports.AppModule = (_dec = (0, _core.NgModule)({
  ...
  declarations: [_app.AppComponent, _second.SecondComponent],
  providers: [{ provide: _quote.QuoteService, useClass: _quote.QuoteService }],
